...
//console.log(post);
//console.log(posts);
//document.write("{'titleAddres':'"+post.titleAddress+"',");
//document.write("'title':'"+post.title+"',");
//document.write("'authorAddress':'"+post.authorAddress+"',");
//document.write("'author':'"+post.author+"',");
//document.write("'dateAddress':'"+post.dateAddress+"',");
//document.write("'date':'"+post.date+"',");
//document.write("'drawingAddress':'"+post.drawingAddress+"'},");
